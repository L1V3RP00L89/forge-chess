...
| M11 | Personal repertoire import & drill practice — import Kris's purchased PGN repertoires, practice/quiz them against deviation                  | **Scoped 2026-08-19 — Dara pass done against real files, ready for Priya**                              | Renee → Dara → Priya |
...
**Not yet folded into Dara's spec above** — Kris asked to get Renee's explicit pedagogy sign-off on branch-point vs. full-line drilling before locking this into the UI spec or Priya's implementation plan. Next step is that sign-off, then updating the spec and brief together.
