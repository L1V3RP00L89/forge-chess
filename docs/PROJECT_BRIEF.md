...
| M11 | Personal repertoire import & drill practice — import Kris's purchased PGN repertoires, practice/quiz them against deviation                  | **Scoped 2026-08-19 — Renee + Dara passes done, ready for Priya**                                       | Renee → Dara → Priya |
...
**Next:** Priya scopes implementation against the finalized spec.
